...
class TestHandler(http.server.BaseHTTPRequestHandler):
    ...
    # The html part returns the information loading the template called list.html (stored in the folder...) THE JINJA THING
    ...
    def karyotype(self, params):
        ...
        html = env.get_template("karyotype.html").render(species=species, karyotype=karyotype)
        return html, "text/html"
    ...
    def geneCalc(self, params):
        ...
        html = env.get_template("geneCalc.html").render(gene=gene, gene_id=gene_id, length=length, a=a_pct, c=c_pct,
                                                        g=g_pct, t=t_pct)
